...
namespace DrSwizzler.Swizzling
{
    ...
    {
        public static byte[] PS5Swizzle(byte[] deswizzledData, int width, int height, int sourceBytesPerPixelSet, int pixelBlockSize, int formatbpp, int minBufferSize = 0x100)
        {
