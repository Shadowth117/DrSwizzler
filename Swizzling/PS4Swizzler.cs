...
namespace DrSwizzler.Swizzling
{
    ...
    {
        public static byte[] PS4Swizzle(byte[] deswizzledData, int width, int height, int sourceBytesPerPixelSet, int pixelBlockSize, int formatbpp, int minBufferSize = 0x200)
        {
